    ...
    T: Transcript + CanonicalSerialize + CanonicalDeserialize,
{
    ...
    /// The public inputs to this proof
    pub public_inputs: Vec<<PCS::Commitment as AffineRepr>::ScalarField>,
    ...
    T: Transcript + CanonicalSerialize + CanonicalDeserialize,
{
    ...
    pub fn new(
        ...
        public_inputs: Vec<<PCS::Commitment as AffineRepr>::ScalarField>,
        transcript: T,
    ) -> Self {
        Self {
            proof,
