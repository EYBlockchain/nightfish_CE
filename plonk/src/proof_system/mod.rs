    ...
    T: Transcript + CanonicalSerialize + CanonicalDeserialize,
{
    ...
    /// The hash of the public inputs to this proof represented by two field elements.
    pub pi_hash: [<PCS::Commitment as AffineRepr>::ScalarField; 2],
    ...
    T: Transcript + CanonicalSerialize + CanonicalDeserialize,
{
    ...
    pub fn new(
        ...
        pi_hash: [<PCS::Commitment as AffineRepr>::ScalarField; 2],
        transcript: T,
    ) -> Self {
        Self {
            proof,
