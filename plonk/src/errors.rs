...
use jf_primitives::{pcs::errors::PCSError, poseidon::PoseidonError};
...
pub enum PlonkError {
    ...
    /// Sumcheck related errors
    PolynomialError(crate::nightfall::mle::mle_structs::PolynomialError),
    /// Invalid SRS
    InvalidSRS,
}
...
impl From<crate::nightfall::mle::mle_structs::PolynomialError> for PlonkError {
    fn from(e: crate::nightfall::mle::mle_structs::PolynomialError) -> Self {
        Self::PolynomialError(e)
    }
}

impl From<PoseidonError> for PlonkError {
    fn from(e: PoseidonError) -> Self {
        Self::PrimitiveError(jf_primitives::errors::PrimitivesError::PoseidonError(e))
    }
}
