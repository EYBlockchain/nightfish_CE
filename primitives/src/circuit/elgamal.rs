...
use ark_ec::{
    short_weierstrass::Affine as SWAffine, twisted_edwards::TECurveConfig, AffineRepr, CurveGroup,
};
...
where
    F: PrimeField,
    P: TECurveConfig<BaseField = F> + HasTEForm<BaseField = F>,
{
